...
public class CustomerDaoImpl implements CustomerDao {
    ...
    public List<String> queryTypes() {
        String sql = "SELECT DISTINCT customer_type.type_name FROM customer_info LEFT JOIN customer_type ON customer_info.type_id = customer_type.type_id;";

...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 员工相关 <span
        class="c-gray en">&gt;</span> 公告 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
...
<div class="cl pd-5 bg-1 bk-gray"><span class="l"> <a
        ...
        class="r">共有数据：<strong>${fn:length(requestScope.notices)}</strong> 条</span></div>
<div class="mt-20">

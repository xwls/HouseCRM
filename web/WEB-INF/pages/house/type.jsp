...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 员工相关 <span
        class="c-gray en">&gt;</span> 房屋类型 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
...
<div class="page-container">
    <div class="text-c">
        ...
        <input type="text" name="queryBy-input" id="queryBy-input" placeholder=" 房屋类型" style="width:200px" class="input-text">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"> <a
            ...
            class="r">共有数据：<strong>${fn:length(requestScope.houseTypes)}</strong> 条</span></div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tbody>
            <s:iterator value="#request.houseTypes">
                <tr class="text-c">
                    <td>${type_id}</td>
                    <td>${type_name}</td>
